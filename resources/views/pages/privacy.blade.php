    ...
    <section class="pb-20 pt-28 sm:pb-24 sm:pt-32">
        <div class="mx-auto max-w-4xl px-6 lg:px-8">
            <div class="panel legal-copy p-8 sm:p-10" data-reveal>
                ...
                <h2>1. Who we are</h2>
                <p>INFX Solutions (Pty) Ltd is a Zoho Authorised Partner based in South Africa. This site helps prospective buyers explore Zoho options and request support from our team.</p>
                ...
                <p>We use this information to respond to your enquiry, help you explore the right Zoho solution, improve our marketing, and keep track of customer requests so we can respond properly.</p>
                ...
                <p>We keep enquiry and journey data only as long as needed to support your request, deliver our services, meet compliance needs, and report on site performance, or until you ask us to remove it where applicable.</p>
