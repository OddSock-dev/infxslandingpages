...
@section('content')
    ...
    <section id="qualify" class="relative z-20 pb-16 sm:pb-20 lg:-mt-10 lg:pb-24">
        <div class="mx-auto max-w-7xl px-6 lg:flex lg:justify-end lg:px-8">
            <div class="relative lg:w-[30rem] lg:-translate-y-52 xl:w-[32rem] xl:-translate-y-56" data-reveal style="transition-delay: 120ms">
                <div class="absolute inset-0 rounded-[2rem] bg-linear-to-br from-teal-400/14 via-transparent to-cyan-400/10 blur-2xl"></div>
                <div class="relative">
    ...
    <div class="relative z-10 bg-canvas pt-2 sm:pt-4">
    ...
    <section class="pb-16 sm:pb-24">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="relative overflow-hidden rounded-[2rem] border border-slate-200/80 bg-linear-to-br from-white/95 via-white/92 to-teal-50/80 px-6 py-6 shadow-[0_28px_70px_rgba(15,23,42,0.08)] sm:px-8 sm:py-8">
                ...
                <div class="relative grid gap-8 lg:grid-cols-[0.92fr_1.08fr]">
                    <div class="relative overflow-hidden rounded-[1.75rem] border border-slate-200/80 bg-slate-950 shadow-hero" data-reveal>
                        ...
                        <img src="{{ asset(data_get($content, 'spotlight.media_url', 'media/systems-audit.webp')) }}" alt="{{ data_get($content, 'spotlight.media_alt', 'Business systems audit illustration') }}" class="h-full min-h-[20rem] w-full object-cover">
                    </div>
